...
CREATE TABLE "biometric_access" (
    ...
    CONSTRAINT "biometric_access_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "biometric_access" ADD CONSTRAINT "biometric_access_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
