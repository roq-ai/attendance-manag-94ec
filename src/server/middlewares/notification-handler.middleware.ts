...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'biometric_access.create': {
    roles: ['business-owner'],
    key: 'biometric-access-setup',
    tenantPath: ['organization', 'user', 'biometric_access'],
    userPath: [],
  },
  'biometric_access.update': {
    roles: ['business-owner'],
    key: 'biometric-access-integration',
    tenantPath: ['organization', 'user', 'biometric_access'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['it-administrator'];
